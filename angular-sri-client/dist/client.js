...
_module.factory({
                 vskoApi2: __webpack_require__(329),
                 apiUtils: __webpack_require__(331)
});

_module.provider('sriClientConfiguration', __webpack_require__(332));
...
var getAllHrefsWithoutBatch = function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(baseHref, parameterName, hrefs, params, options, core) {
    var total, promises, allResults, map, query, i, partPromise;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            if (!(total < hrefs.length)) {
              _context4.next = 24;
              break;
            }

            query = paramsToString(baseHref, params) + '&' + parameterName + '=';
            ...
            partPromise = getAll(query, null, options);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            options = options || {};
            params.limit = 500;
            return _context5.abrupt('return', getAllHrefsWithoutBatch(baseHref, 'hrefs', values, params, options, core));
