  ...
  return new Promise(function(resolve, reject) {
    my.baseRequest({
      ...
      if(!error && response.statusCode >= 200 && response.statusCode < 400) {
        ...
        reject(new SriClientError(handleError('GET ' + baseUrl + commonUtils.parametersToString(href, params), error, response, my.configuration, options, stack)));
      }
    });
  });
    ...
    /*const response = await my.baseRequest({
      ...
      if(response.statusCode >= 200 && response.statusCode < 400) {
        ...
        throw new SriClientError(handleError('GET ' + baseUrl + commonUtils.parametersToString(href, params), null, response, my.configuration, options, stack));
